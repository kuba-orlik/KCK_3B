...
Sim.App.prototype.init = function(param)
{
    ...
    var scene = this.createScene(camera, root);
...
Sim.App.prototype.createScene = function(camera, root){
...
Sim.App.prototype.run = function()
{
	...
	for(var i=1; i<=2; i++){
		...
		for(var o in this.objects){
			if(this.objects[o].order==i){
				//console.log(this.objects[o]);
				root.add(this.objects[o]);
			}
		}
		var temp_scene = new THREE.Scene();
		temp_scene = this.createScene(this.camera, root);
